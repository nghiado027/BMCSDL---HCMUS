...
namespace lab_nhom.DAO
{
    public class DAO_NhanVien
    {
        ...
        {
            DataProvider dp = new DataProvider();
            object[] data = new object[7] { nv.maNV, nv.hotenNV, nv.emailNV, nv.Luong, nv.tendnNV, nv.matkhauNV, nv.pubkey };
            dp.ExecuteNonQuery("EXEC SP_INS_PUBLIC_ENCRYPT_NHANVIEN  @MANV , @HOTEN , @EMAIL , @LUONG , @TENDN , @MATKHAU , @PUB", data);
        }
        ...
        public void SuaNhanVien(DTO_NhanVien nv)
        {
            DataProvider dp = new DataProvider();
            object[] data = new object[7] { nv.maNV, nv.hotenNV, nv.emailNV, nv.Luong, nv.tendnNV, nv.matkhauNV, nv.pubkey };
            dp.ExecuteNonQuery("EXEC SP_UPD_NHANVIEN  @MANV , @HOTEN , @EMAIL , @LUONG , @TENDN , @MATKHAU , @PUB", data);
        }
    }
}
